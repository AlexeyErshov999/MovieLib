...
## Важно: в приложении не реализовано сохранение таблицы сравнения (не было в требованиях), чтобы увидеть сравнение фильмов, н едолжно произойти перезагрузки страницы.
